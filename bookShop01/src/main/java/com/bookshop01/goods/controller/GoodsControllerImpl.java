...
//	traditionalHealth 추가(전통건강식품)
	@RequestMapping(value="/traditionalHealth.do" ,method = RequestMethod.GET)
	public ModelAndView traditionalHealth(HttpServletRequest request, HttpServletResponse response) throws Exception{
		String viewName=(String)request.getAttribute("viewName");
		List<GoodsVO> goodsList=goodsService.allGoodsList();
		ModelAndView mav = new ModelAndView(viewName);
		mav.addObject("goodsList", goodsList);
