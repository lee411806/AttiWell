   ...
   <section id="new_book">
      ...
      <div id="left_scroll">
         <a href='javascript:slide("left");'><img
            src="${contextPath}/resources/image/left.gif" style="width:30px; height:40px; margin:45px 25px 0px 0px"></a>
      </div>
      ...
      <div id="right_scroll">
         <a href='javascript:slide("right");'><img
            src="${contextPath}/resources/image/right.gif" style="width:30px; height:40px; margin-top:45px"></a>
      </div>
