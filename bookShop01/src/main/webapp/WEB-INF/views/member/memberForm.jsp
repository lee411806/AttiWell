      ...
      <div class="input-form-backgroud row">
         <div class="input-form col-md-12 mx-auto">
            ...
            <form action="${contextPath}/member/addMember.do" method="post"
               ...
               <div class="row">
                  <div class="col-md-9">
                     <label for="username">아이디<span style="color: red">
                           *</span></label> <input type="text" name="member_id" class="form-control"
                        id="member_id" placeholder="아이디를 입력해주세요." maxlength="15" pattern="^[a-zA-Z0-9]{5,15}$" value="" required>
                  ...
                  <div class="col-md-3">
                     ...
                     <button class="btn-lg btn-block" type="button" id="btnOverlapped"
                        style="background: #660033; border-style: hidden; color: white"
               ...
               <div class="row">
                  <div class="col-md-9">
                     <label for="password">패스워드<span style="color: red">
                        ...
                        id="password" placeholder="패스워드를 입력해주세요." maxlength="15" pattern="^(?=.*[a-zA-Z])(?=.*\d).{8,}$" value=""
                     ...
                     <label for="confirmPassword">패스워드 확인<span
                        ...
                        placeholder="패스워드를 입력해주세요." maxlength="15" pattern="^(?=.*[a-zA-Z])(?=.*\d).{8,}$" value="" oninput="checkPassword()"
                        required>
               ...
               <div class="row">
                  <div class="col-md-9">
                     <label for="name">이름<span style="color: red"> *</span></label> <input
                        ...
                        placeholder="이름을 입력해주세요." maxlength="6" pattern="^[가-힣]{2,6}$" value=""
                        required>
