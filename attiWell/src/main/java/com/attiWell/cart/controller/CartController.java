...
public interface CartController {
	...
	public @ResponseBody String addGoodsInCart(@RequestParam("goods_id") int goods_id,	@RequestParam("orderGoodsQty") int orderGoodsQty,HttpServletRequest request, HttpServletResponse response)  throws Exception;
