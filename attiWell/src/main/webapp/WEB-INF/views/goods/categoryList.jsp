...
<title>${goodsList[category] }</title>
</head>
<body>
	<hgroup>
		<h1>${category }</h1>
	...
	<div id="sorting">
		<ul>
			<li><a
				href="${contextPath}/goods/selectGoodsList.do?category=${category }&sort=latest"
				id="latestLink">최신순</a></li>
			<li><a
				href="${contextPath}/goods/selectGoodsList.do?category=${category }&sort=highPrice"
				id="highPriceLink">높은가격순</a></li>
			<li><a
				href="${contextPath}/goods/selectGoodsList.do?category=${category }&sort=lowPrice"
	...
	<div id="page_wrap">
		<ul id="page_control">
			<c:forEach var="page" begin="1"
				end="${(fn:length(goodsList[category]) + 9) / 10}" step="1">
				<c:url value="selectGoodsList.do" var="pagingUrl">
				...
				<c:if test="${page == 10}">
					<c:url value="selectGoodsList.do" var="nextPageUrl">
						<c:param name="category" value="${category }" />
