...
<body>
	...
	<div id="sorting">
		<ul>
			<li><a
				href="${contextPath}/goods/searchGoods.do?searchWord=${searchWord }&sort=latest"
				id="latestLink">최신순</a></li>
			<li><a
				href="${contextPath}/goods/searchGoods.do?searchWord=${searchWord }&sort=highPrice"
				id="highPriceLink">높은가격순</a></li>
			<li><a
				href="${contextPath}/goods/searchGoods.do?searchWord=${searchWord }&sort=lowPrice"
	...
	<div id="page_wrap">
		<ul id="page_control">
			<c:forEach var="page" begin="1" end="${(totalCount + 9) / 10}"
				step="1">
				<c:url value="searchGoods.do" var="pagingUrl">
				...
				<c:if test="${page == 10}">
					<c:url value="searchGoods.do" var="nextPageUrl">
						<c:param name="searchWord" value="${searchWord }" />
