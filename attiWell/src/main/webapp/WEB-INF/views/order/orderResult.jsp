			...
			<TR>
				<c:forEach var="item" items="${myOrderList }">
					...
					<td><c:if test="${total_order_price > 50000}">
						...
						<h2 id="p_totalDelivery">${total_delivery_price }원</h2> <input
						id="h_totalDelivery" type="hidden" value="${total_delivery_price}" /></td>
					...
					<td>
						<h2>${item.order_goods_qty *item.goods_sales_price + total_delivery_price}원</h2>
					</td>
			</TR>
			</c:forEach>
		</TBODY>
