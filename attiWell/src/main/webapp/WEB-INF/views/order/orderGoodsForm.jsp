       ...
       <table>
         <tbody>
          <tr>
            ...
            <td>
             <input class="inputBox" type="text" value="${orderer.member_name}" size="15" required />
            </td>
           </tr>
           <tr>
            <td><label class="lableBox">핸드폰</label></td>
            <td>
             <input class="inputBox" type="text" value="${orderer.hp1}-${orderer.hp2}-${orderer.hp3}" size="15" required />
            </td>
           </tr>
           <tr>
            <td><label class="lableBox">이메일</label></td>
            <td>
             <input class="inputBox" type="text" value="${orderer.email1}@${orderer.email2}" size="15" required />
            </td>
           </tr>
         </tbody>
      </table>
      ...
      <table>
         <tbody>
            ...
            <tr>
               ...
               <td><input  class="inputBox" id="receiver_name" name="receiver_name" type="text" size="40" value="${orderer.member_name }" />
            ...
            <tr>
               ...
               <td><select class="inputBox_select" id="hp1" name="hp1">
                 ...
                 <input class="inputBox_select" size="10px" type="text" id="hp2" name="hp2" value="${orderer.hp2 }"> 
                 <input class="inputBox_select" size="10px" type="text" id="hp3" name="hp3" value="${orderer.hp3 }"><br><br> 
            ...
            <tr>
               ...
               </select>  <input class="inputBox_select" type="text" id="tel2" name="tel2" value="${orderer.tel2 }">  <input class="inputBox_select" type="text" id="tel3" name="tel3" value="${orderer.tel3 }">
               </td>
            ...
            <tr>
               ...
               <td style="margin-top: 30px">&nbsp;<br><input class="inputBox_select" type="text" id="zipcode" name="zipcode" size="5"
                  value="${orderer.zipcode }"> 
                  <a href="javascript:execDaumPostcode()" class="button">우편번호검색</a> <br>
                  <p>
                     
                     <input  class="inputBox" type="text" id="roadAddress" name="roadAddress" size="50" value="${orderer.roadAddress }" placeholder="지번 주소를 입력하세요." /><br>
                        <input  class="inputBox" type="text" id="jibunAddress" name="jibunAddress" size="50"
                                      value="${orderer.jibunAddress }" placeholder="도로명 주소를 입력하세요." /><br>
                        <input  class="inputBox" type="text" id="namujiAddress"  name="namujiAddress" size="50"
            ...
            <tr>
               ...
               <td>
                  <input  class="inputBox" id="delivery_message" name="delivery_message" type="text" size="50"
...
<!--             <td>예상적립금</td> -->
         ...
         <tr>
            <c:forEach var="item" items="${myOrderList }">
               <td class="goods_image goods_buttom">
...
<!-- ----------------------------------------------------------------------------------------------------------------- -->         
      ...
      <table class="list_view" style="background: rgb(230, 230, 230); width: 700px;">
      <tbody>
...
<%--    <br>
   <p>할인 정보</p>
    <div>
      <table>
         <tbody>
            <tr>
               <td width=170px><label class="lableBox">적립금</label></td>
               <td><input class="inputBox_select" name="discount_juklip" type="text" size="10" /> 원 / 1000원
                  &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두 사용하기</td>
            </tr>
            <tr>
               <td><label class="lableBox">예치금</label></td>
               <td><input class="inputBox_select" name="discount_yechi" type="text" size="10" /> 원 / 1000원
                  &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두 사용하기</td>
            </tr>
            <tr>
               <td><label class="lableBox">상품권 전환금</label></td>
               <td cellpadding="5"><input class="inputBox_select" name="discount_sangpum" type="text"
                  size="10" /> 원 / 0원 &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두
                  사용하기</td>
            </tr>
            <tr>
               <td><label class="lableBox">OK 캐쉬백 포인트</label></td>
               <td cellpadding="5"><input class="inputBox_select" name="discount_okcashbag" type="text"
                  size="10" /> 원 / 0원 &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두
                  사용하기</td>
            </tr>
            <tr>
               <td><label class="lableBox">쿠폰할인</label></td>
               <td cellpadding="5"><input class="inputBox_select" name="discount_coupon" type="text"
                  size="10" /> 원 / 0원 &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두
                  사용하기</td>
            </tr>
         </tbody>
   ...
   <br>
   <table width=80% class="list_view" style="background: rgb(230, 230, 230)">
      <tbody>
         <tr align=center class="fixed">
            <td class="fixed">총 상품수</td>
            <td>총 상품금액</td>
...
<!-- ------------------------      1      -------------------------- -->
   ...
   <div>
         ...
         <tbody>
            ...
            <tr style="height: 40px;">
               <td>
                 ...
                 <td>
                  <input type="radio" id="pay_method" name="pay_method" value="페이나우(간편결제)"> &nbsp;페이나우 &nbsp;&nbsp;&nbsp; 
                </td>
                 <td>
      ...
      <tbody>
               ...
               <td >
                 <strong>카드 선택 &nbsp;:&nbsp;</strong> 
                 <select class="inputBox_select" id="card_com_name" name="card_com_name">
            ...
            <td>
               <strong>할부 기간 &nbsp;:&nbsp;<strong> 
               <select class="inputBox_select" id="card_pay_month" name="card_pay_month">
              ...
              <strong>휴대폰 번호 입력 &nbsp;:&nbsp;<strong> 
              <select class="inputBox_select" id="pay_order_tel1" name="pay_order_tel1">
                     <option value="010" selected>&nbsp;010</option>
                     <option value="011">&nbsp;011</option>
                     <option value="016">&nbsp;016</option>
                     <option value="017">&nbsp;017</option>
                     ...
                     <option value="019">&nbsp;019</option>
                        ...
                        <!-- <input class="inputBox_select" type="text" size="5" value=""  id="pay_order_tel1" name="pay_order_tel1" required/> -->
                       <input class="inputBox_select" type="text" size="5" value="" id="pay_order_tel2" name="pay_order_tel2" required />
                       <input class="inputBox_select" type="text" size="5" value="" id="pay_order_tel3" name="pay_order_tel3" required />
              </td>
            </tr>
...
<!-- ------------------------      1      -------------------------- -->
   ...
   <center>
      ...
      <input class="myButton" style="width: 500px" type="button" value="결제하기">
<%--       <img width="125" alt="" src="${contextPath}/resources/image/btn_gulje.jpg"> --%>
      </a> <a href="${contextPath}/main/main.do"> 
      <input class="myButton" style="background-color: rgb(200, 200, 200); width: 190px" type="button" value="쇼핑 계속하기">
         ...
         <table class="order_table">
            ...
            <br>
               ...
               <tr>
                ...
                <td>
                    <p class="expanding-box" id="p_total_order_goods_qty"> 주문 상품개수 </p>    
                </td>
               </tr>
               <tr>
                 <td width=200px>
            ...
            <br>
            <input class="myButton" name="btn_process_pay_order" type="button" onClick="fn_process_pay_order()" value="최종결제하기">
               <a href="javascript:" onClick="javascript:imagePopup('close', '.layer01');">
            <input class="myButton2" name="btn_process_pay_order" type="button" value="닫기"></a> 
