               ...
               <tbody>
                  ...
                  <input type="radio" name="member_gender" value="101"
                     ...
                     <input type="radio" name="member_gender"
                                 value="101" disabled />남성
                  </c:otherwise>
                        </c:choose></td>
                  </tr>
                  <tr>
                     <td class="fixed_join">법정생년월일</td>
                     <td><select name="member_birth_y" disabled>
                     ...
                     </select>년 <select name="member_birth_m" disabled>
                     ...
                     </select>월 <select name="member_birth_d" disabled>
                  ...
                  <tr>
                     ...
                     <td><select name="tel1" disabled>
                        ...
                        value="${memberInfo.tel2 }" disabled> - <input
                  ...
                  <tr>
                     ...
                     <td><select name="hp1" disabled>
                        ...
                        value="${memberInfo.hp2 }" disabled> - <input
                        type="text" name="hp3" size=4 value="${memberInfo.hp3 }"
                        disabled><br> <br> <c:choose>
                     ...
                     <td><input type="text" id="zipcode" name="zipcode" size=5
                        ...
                        <p>
                           ...
                           <br> 나머지 주소: <input type="text" name="namujiAddress"
                              size="50" value="${memberInfo.namujiAddress }" disabled /> <span
